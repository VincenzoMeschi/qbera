	...
	return (
		<div className={cn("relative h-screen", className)}>
			<CircularText
				...
				onHover="slowDown"
				spinDuration={20}
				className="absolute -bottom-15 right-10 z-50 overflow-visible"
			/>
			<div className="flex w-full bg-transparent h-screen items-center justify-end absolute p-2 z-10">
				<div className="relative w-full h-full bg-secondary-foreground rounded-[2.5rem] z-10 overflow-hidden">
					...
					<div className="absolute bottom-0 left-0 bg-background flex pl-16 w-96 py-10 rounded-tr-[2.5rem] z-20">
					...
					<div
						className="absolute w-10 h-10 left-[24rem] bottom-0 bg-transparent shadow-[0_0_0_1rem_#F0F0F0,0_0_0_0_#F0F0F0] rounded-bl-[2.5rem] z-10"
						style={{ clipPath: "inset(0)" }}></div>
					<MainGrid className="h-full z-0">
						<div className="flex col-span-full lg:col-span-6 lg:items-center items-end z-10 row-end-1">
							<h1 className="text-primary-foreground text-7xl sm:text-8xl xl:text-9xl uppercase text-shadow-lg pb-32 lg:pb-0">
								{mainHeading}
							</h1>
						</div>
