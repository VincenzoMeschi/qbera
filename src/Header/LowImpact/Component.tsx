		...
		<div className={cn("relative h-[30rem]", props.className)}>
			<div className="flex w-full bg-transparent h-[30rem] items-center justify-end absolute p-2 z-10">
				<div className="relative w-full h-full bg-secondary-foreground rounded-[2.5rem] z-10 overflow-hidden">
					<Nav />
					<div className="absolute bottom-0 left-0 bg-background flex pl-16  w-full md:w-[37rem] h-44 md:rounded-tr-[2.5rem] z-10" />
					<div
					...
					<div
						className="absolute w-10 h-10 bottom-44 right-0 md:left-[37rem] md:bottom-0 bg-transparent shadow-[0_0_0_1rem_#F0F0F0,0_0_0_0_#F0F0F0] rounded-br-[2.5rem] md:rounded-bl-[2.5rem] md:rounded-br-none z-10"
						style={{ clipPath: "inset(0)" }}></div>
