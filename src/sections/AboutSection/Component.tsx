	...
	return (
		<div className="w-full h-full">
			<MainGrid className="h-full">
					...
					<div className="col-span-4 sm:col-span-6 lg:col-span-8">
						<div className="rounded-t-[2.5rem] lg:rounded-br-[2.5rem] overflow-hidden relative">
							<div className="LAYERMASK">
								<div className="w-80 lg:w-96 h-38 bg-secondary absolute bottom-0 left-0 rounded-tr-[2.5rem] z-1" />

								<div className="w-full lg:w-42 h-20 bg-secondary absolute bottom-0 left-80 lg:left-96 lg:rounded-tr-[2.5rem] z-1" />
								<div
									className="absolute w-10 h-10 left-80 lg:left-96 bottom-20 bg-transparent shadow-[0_0_0_1rem_#F0F0F0,0_0_0_0_#F0F0F0] rounded-bl-[2.5rem] z-10"
									style={{ clipPath: "inset(0)" }}
								/>
								<div
									className="absolute w-10 h-10 left-0 bottom-38 bg-transparent shadow-[0_0_0_1rem_#F0F0F0,0_0_0_0_#F0F0F0] rounded-bl-[2.5rem] z-10"
									style={{ clipPath: "inset(0)" }}
								/>
								<div
									className="absolute w-10 h-10 bottom-20  right-0 lg:left-[34.5rem] lg:bottom-0 bg-transparent shadow-[0_0_0_1rem_#F0F0F0,0_0_0_0_#F0F0F0] rounded-bl-[2.5rem] z-10 scale-x-[-1] lg:scale-x-[1]"
									style={{ clipPath: "inset(0)" }}
								/>
							</div>

							<div className="absolute bottom-20 lg:bottom-18 left-0 z-10">
								<h2 className="uppercase text-primary text-6xl lg:text-7xl">
									{leftSide.mainHeading}
								</h2>
							</div>
							<div className="absolute w-full lg:w-[33rem] bottom-0 left-0 z-10">
					...
					<div className="col-span-4 sm:col-span-6 lg:col-span-8 pb-8">
						<div className="flex flex-col justify-between w-full h-full z-20 gap-8">
							<div className="flex flex-col gap-8">
								...
								<p className="text-primary leading-snug pr-20">
									{leftSide.subText}
								</p>
							</div>
				...
				<RightColumnAbout
					className={cn(
						"flex md:flex-row gap-5 lg:col-start-9 sm:col-span-6 col-span-4",
						isHomePage
