					...
					{coaches.coach.map((coach, i) => {
						return (
							<div key={i} className="contents group">
								...
								<label
									htmlFor={`coach-${i}`}
									className="flex flex-1 peer-checked:flex-3 lg:peer-checked:flex-2 transition-all duration-300 ease-in-out rounded-[2.5rem] h-[36rem] cursor-pointer md:justify-end items-end relative overflow-hidden peer-checked:[&>p]:opacity-90 peer-checked:[&>p]:delay-200 peer-checked:[&>div]:block">
									...
									<div className="hidden md:block z-1 absolute h-full w-full bg-gradient-to-t from-black to-[#0000007f] md:to-transparent opacity-80"></div>
									<Image
